Vagrant.configure("2") do |config|    
    config.vm.define :app01 do |app01|
        app01.vm.box = "puppetlabs/centos-7.0-64-nocm"
        ...
        app01.vm.provider :virtualbox do |vbapp01|
            ...
            vbapp01.customize ["modifyvm", :id, "--cpuexecutioncap", "25"]
        end
        ...
        app01.vm.provision "puppet", run: "always" do |puppetapp01|
            ...
            puppetapp01.manifest_file       = "test.pp"
            puppetapp01.working_directory = "/vagrant/puppet/manifest"
            puppetapp01.options = [
                '--verbose',
                '--debug',
            ]
    ...
    #    app02.vm.box = "puppetlabs/centos-7.0-64-nocm"
    ...
    #    mem01.vm.box = "puppetlabs/centos-7.0-64-nocm"
    ...
    #    dat01.vm.box = "puppetlabs/centos-7.0-64-nocm"
